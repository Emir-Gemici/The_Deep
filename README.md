...
```
1. python olaylar.py video.mp4     →  olaylar_cikti.json   (zaman damgalı olay adayları)
2. python vLLM.py video.mp4        →  vlm_rapor.json       (Türkçe nihai rapor — ajanı çalıştırır)
